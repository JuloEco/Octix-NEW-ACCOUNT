...
def envoyer_email_confirmation(destinataire: str, username: str) -> tuple[bool, str]:
    """Envoie l'e-mail de bienvenue à `destinataire` sans faire planter Flask."""
    ...
    try:
        ...
        logger.info(f"[EMAIL] E-mail envoyé avec succès à {destinataire}")
...
def envoyer_code_reinitialisation(destinataire: str, username: str, code: str) -> tuple[bool, str]:
    ...
    try:
        ...
        logger.info(f"[EMAIL] Code envoyé avec succès à {destinataire}")
